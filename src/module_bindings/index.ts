...
import ScoreCitiesReducer from "./score_cities_reducer";
...
import CityLanguageRow from "./city_language_table";
import ScoreResultRow from "./score_result_table";
import TranslationRow from "./translation_table";
...
const tablesSchema = __schema({
  ...
  city_language: __table({
    ...
    constraints: [
      { name: 'city_language_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, CityLanguageRow),
  score_result: __table({
    name: 'score_result',
    indexes: [
      { name: 'id', algorithm: 'btree', columns: [
        'id',
    ...
    constraints: [
      { name: 'score_result_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, ScoreResultRow),
  translation: __table({
    name: 'translation',
    ...
    constraints: [
      { name: 'translation_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, TranslationRow),
});
...
const reducersSchema = __reducers(
  __reducerSchema("score_cities", ScoreCitiesReducer),
